...
impl DeferredDelivery {
    ...
    pub fn accept(self, queue_id: Option<&str>) {
        ...
        let reply_bytes = match queue_id_owned.as_deref() {
            Some(id) => crate::reply::reply_enhanced(250, "2.0.0", &format!("Queued as {id}")),
            None => crate::reply::reply_enhanced(250, "2.0.0", "Message accepted for delivery"),
        };
    ...
    pub fn reject(self, code: u16, text: &str) {
        ...
        self.handle.send(crate::reply::reply(code, text));
    }
