...
use crate::codec::{SmtpCommand, SmtpServerLexer};
use crate::data::{BdatAccumulator, DotUnstuffer};
use crate::delivery::{
...
use crate::handler::DeferredSlot;
use crate::metrics::SmtpServerMetrics;
use crate::pipeline::SmtpPipeline;
use crate::reply::{reply, reply_enhanced, reply_ehlo, reply_multiline};
use crate::service::SmtpConfig;
use crate::session::SmtpSessionState;
...
impl SmtpControlHandler {
    ...
    pub fn new(
        ...
        Self {
            ...
            message: None,
            pipeline: None,
            lexer: SmtpServerLexer::new(8192),
